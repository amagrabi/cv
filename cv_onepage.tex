...
%--------------------TITLE-------------
\par{\centering
		{\Large Amadeus \textsc{Magrabi}, PhD \\[2mm]
	}\par}
...
\textsc{Python} (main), \textsc{R}, \textsc{Matlab}, \textsc{Java} (basics)
\vspace{1.5mm}

\textbf{Python Libraries}\\
\textsc{FastAPI}, \textsc{Flask}, \textsc{Ruff}, \textsc{Pandas}
\vspace{1.5mm}

\textbf{ML Frameworks}\\
\textsc{MLflow}, \textsc{Scikit-Learn}, \textsc{PyTorch}, \textsc{Keras}, \\ \textsc{LlamaIndex}
\vspace{1.5mm}
...
\textbf{Cloud}\\
\textsc{Azure} (most recent), \textsc{GCP}, \textsc{AWS}, \textsc{Heroku}
\vspace{1.5mm}
...
\begin{itemize}[leftmargin=1em, itemsep=1mm, parsep=0.5mm]
  ...
  \item Awarded with stipend from \href{https://www.dfg.de/en/research_funding/programmes/excellence_initiative/index.html}{Excellence Initiative} of German Research Foundation.
\end{itemize}
